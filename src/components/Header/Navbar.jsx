...
const Navbar = () => {
    ...
    return (
        <div className='w-full mx-auto'>
            <div className="navbar bg-base-100 max-w-6xl mx-auto px-0">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl px-0 font-bold">Book Voyage</a>
                </div>
                ...
                <div className="navbar-end">
                    <a className="btn bg-lime-300 text-base text-black">Button</a>
                </div>
            </div>
        </div>
